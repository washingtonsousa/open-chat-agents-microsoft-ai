...
namespace OpenChatAgents.Infrastructure.Migrations
{
    ...
    [Migration("20260922183451_AddSkillsSubAgentsBuiltInToolsAndChatImages")]
    partial class AddSkillsSubAgentsBuiltInToolsAndChatImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.AgentMcpServer", b =>
                {
                    b.Property<Guid>("AgentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.AgentSkill", b =>
                {
                    b.Property<Guid>("AgentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.AgentSubAgent", b =>
                {
                    b.Property<Guid>("AgentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("AgentId", "SubAgentId");

                    b.HasIndex("SubAgentId");

                    b.ToTable("agent_sub_agents", (string)null);
                });

            modelBuilder.Entity("OpenChatAgents.Domain.Models.ConsumerApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("consumer_applications", (string)null);
                });
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.McpServer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.AgentMcpServer", b =>
                {
                    b.HasOne("OpenChatAgents.Domain.Models.Agent", "Agent")
                        .WithMany("McpServerLinks")
                        .HasForeignKey("AgentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpenChatAgents.Domain.Models.McpServer", "McpServer")
                        .WithMany("AgentLinks")
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.AgentSkill", b =>
                {
                    ...
                    b.HasOne("OpenChatAgents.Domain.Models.Skill", "Skill")
                        .WithMany("AgentLinks")
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.AgentSubAgent", b =>
                {
                    b.HasOne("OpenChatAgents.Domain.Models.Agent", "Agent")
                        .WithMany("SubAgentLinks")
                        .HasForeignKey("AgentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpenChatAgents.Domain.Models.Agent", "SubAgent")
                        .WithMany()
            ...
            modelBuilder.Entity("OpenChatAgents.Domain.Models.Agent", b =>
                {
                    ...
                    b.Navigation("McpServerLinks");

                    b.Navigation("Sessions");

                    b.Navigation("SkillLinks");

                    b.Navigation("SubAgentLinks");
                });
